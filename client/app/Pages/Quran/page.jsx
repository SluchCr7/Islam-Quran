...
//   return (
//     <div dir="rtl" className={`min-h-screen flex flex-col font-arabic transition-colors duration-500 
//       ${theme === "dark" ? "bg-gradient-to-br from-gray-950 via-gray-900 to-black text-gray-200" : "bg-gradient-to-br from-gray-100 via-white to-gray-200 text-gray-900"}`}>

//       {/* هيدر */}
//       <div className={`flex justify-between items-center p-4 shadow-lg border-b transition-colors duration-500
//         ${theme === "dark" ? "bg-gradient-to-r from-gray-900 to-gray-800 text-teal-400 border-gray-700" : "bg-gradient-to-r from-emerald-100 to-teal-50 text-emerald-700 border-emerald-300"}`}>
//         <div className="flex flex-row items-center gap-3">
//           <button onClick={() => setMenuOpen(true)} className="hover:scale-110 transition">
//             <CiMenuBurger className="w-7 h-7" />
//           </button>
...
//             <div className={`flex flex-col md:flex-row items-center justify-center gap-4 px-8 py-3 rounded-full shadow-lg transition-colors duration-500
//               ${theme === "dark" ? "bg-gray-900/60 border border-teal-500/50" : "bg-emerald-50 border border-emerald-300"}`}>
//               <h2 className="text-2xl font-bold tracking-wider">{ayahs[0]?.surah?.name}</h2>
//               <div className="flex gap-6 text-sm">
...
//         {/* نص الآيات مدمج */}
//         <motion.div key={page} initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}
//           className={`w-full max-w-3xl rounded-3xl shadow-2xl border p-8 leading-loose text-3xl tracking-wide transition-colors duration-500 text-center
//           ${theme === "dark" ? "bg-gray-900/80 backdrop-blur-xl border-gray-700/60 text-gray-100" : "bg-white border-gray-300 text-gray-900"}`}>

//           {ayahs.map(a => {
//             const isBookmarked = bookmark && bookmark.surahNumber === a.surah.number && bookmark.ayah === a.numberInSurah
//             return (
//               <React.Fragment key={a.number}>
//                 <span className="mx-1">{a.text}</span>
//                 <span
//                   onClick={() => handleBookmark(a)}
//                   className={`inline-flex items-center justify-center w-8 h-8 mx-1 rounded-full text-sm font-bold shadow-md cursor-pointer transition align-middle
//                     ${isBookmarked ? "bg-gradient-to-br from-green-500 to-green-400 text-black ring-2 ring-green-300 scale-110" : "bg-gradient-to-br from-amber-400 to-yellow-500 text-gray-900 hover:scale-105"}`}>
//                   {a.numberInSurah}
//                 </span>
//               </React.Fragment>
//             )
...
//       {/* فوتر مع تحكم الصفحة */}
//       <div className={`p-4 border-t shadow-inner transition-colors duration-500
//         ${theme === "dark" ? "bg-gradient-to-r from-gray-900/95 to-gray-800/90 border-gray-700" : "bg-gradient-to-r from-emerald-50 to-emerald-100 border-emerald-300"}`}>
