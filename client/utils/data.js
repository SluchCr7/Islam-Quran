...
export const alAsharaMubasharoon = {
  1: {
    name: "أبو بكر الصديق",
    fullName: "عبد الله بن أبي قحافة التيمي القرشي",
    title: "خليفة رسول الله",
    notes: "أول الخلفاء الراشدين وأقرب الصحابة إلى النبي ﷺ"
  },
  2: {
    name: "عمر بن الخطاب",
    fullName: "عمر بن الخطاب العدوي القرشي",
    title: "الفاروق",
    notes: "ثاني الخلفاء الراشدين، عُرف بالعدل والقوة"
  },
  3: {
    name: "عثمان بن عفان",
    fullName: "عثمان بن عفان الأموي القرشي",
    title: "ذو النورين",
    notes: "ثالث الخلفاء الراشدين، جمع القرآن في مصحف واحد"
  },
  4: {
    name: "علي بن أبي طالب",
    fullName: "علي بن أبي طالب الهاشمي القرشي",
    title: "أبو الحسن",
    notes: "رابع الخلفاء الراشدين، أول من أسلم من الصبيان"
  },
  5: {
    name: "الزبير بن العوام",
    fullName: "الزبير بن العوام القرشي الأسدي",
    title: "حواري رسول الله",
    notes: "ابن عمة النبي ﷺ وأحد أوائل المسلمين"
  },
  6: {
    name: "طلحة بن عبيد الله",
    fullName: "طلحة بن عبيد الله التيمي القرشي",
    title: "الشهيد الحي",
    notes: "من السابقين إلى الإسلام، من أبطال معركة أحد"
  },
  7: {
    name: "عبد الرحمن بن عوف",
    fullName: "عبد الرحمن بن عوف القرشي الزهري",
    title: "التاجر الأمين",
    notes: "أحد أثرى الصحابة وأكثرهم إنفاقًا في سبيل الله"
  },
  8: {
    name: "سعد بن أبي وقاص",
    fullName: "سعد بن مالك القرشي الزهري",
    title: "أول من رمى بسهم في سبيل الله",
    notes: "قائد معركة القادسية وفاتح العراق"
  },
  9: {
    name: "سعيد بن زيد",
    fullName: "سعيد بن زيد العدوي القرشي",
    title: "أحد السابقين",
    notes: "من أوائل المسلمين وزوج أخت عمر بن الخطاب"
  },
  10: {
    name: "أبو عبيدة بن الجراح",
    fullName: "عامر بن عبد الله بن الجراح الفهري القرشي",
    title: "أمين هذه الأمة",
    notes: "قائد عسكري بارز في الفتوحات الإسلامية"
  }
}
